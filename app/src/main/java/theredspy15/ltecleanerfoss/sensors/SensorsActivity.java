    ...
    public final void onSensorChanged(SensorEvent event) {
        ...
        if( event.sensor.getType() == sensorInd){
            ...
            if(event.sensor.getType() ==  Sensor.TYPE_LIGHT){
                ...
                if(valueZ > 40){
                    sensorLayout.setBackgroundResource(R.drawable.background);
                }else{
                    sensorLayout.setBackgroundResource(R.drawable.ic_launcher_foreground);
                }
                ...
                if(azimuth > 60 && azimuth < 90){
                    ...
                    sensorLayout.setBackgroundResource(R.drawable.ic_launcher_background);
                }else{
                    sensorLayout.setBackgroundResource(R.drawable.background);
                }
            }
